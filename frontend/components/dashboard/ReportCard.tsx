...
export function ReportCard({ report, onDelete, compact }: ReportCardProps) {
  ...
  return (
    <article className="report-card group relative overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.04] transition hover:scale-[1.02] hover:border-teal-500/40 hover:shadow-[0_12px_40px_rgba(20,184,166,0.12)]">
      ...
      <div className="p-4">
        ...
        <h3 className="mt-3 font-semibold text-white">{report.type}</h3>
        ...
        <div className="mt-4 flex gap-2 opacity-100 transition lg:opacity-0 lg:group-hover:opacity-100">
          <Link
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/[0.08] text-slate-400 hover:border-teal-500/40 hover:text-teal-400"
            aria-label="View"
          >
          ...
          <Link
            href="/chat"
            className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/[0.08] text-slate-400 hover:text-teal-400"
            aria-label="Chat"
          >
        ...
        {!compact && (
          <div className="mt-3 flex gap-3 border-t border-white/[0.06] pt-3 lg:hidden">
            <Link href="/dashboard/reports" className="text-xs font-semibold text-teal-400">
              View Analysis
            </Link>
